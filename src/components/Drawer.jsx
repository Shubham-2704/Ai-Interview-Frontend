...
//   }
// }, [explanationId]); // Add explanationId as dependency

// // Save chat history to storage whenever it changes
//   useEffect(() => {
//     if (!explanationId || chatHistory.length === 0) return;

//     // Save chat history for THIS specific explanation
...
// const handleClose = () => {
//   // Reset chat history when closing drawer
//   setChatHistory([]);
//   onClose();
// };
//   return (
...
//                 title="Clear explanation and chat history"
//               >
//                 🗑️ All
//               </Button>
//             </>
        ...
        <div className="flex items-center gap-2">
          {explanationId && explanation && (
            <>
              ...
              className="h-7 text-xs text-destructive flex items-center gap-1"
              title="Clear explanation and chat history"
            >
              {isClearingAll ? (
                <Loader2 className="h-3 w-3 animate-spin" />
